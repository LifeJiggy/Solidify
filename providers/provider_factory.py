...
class ProviderFactory:
    ...
    @classmethod
    def create(cls, name: str, config: Optional[ProviderSettings] = None, **kwargs) -> Optional[Any]:
    ...
    @classmethod
    def create_all(cls, config: Optional[UnifiedProviderConfig] = None) -> Dict[str, Any]:
        """Create all available providers"""
        config = config or get_default_config()
        providers = {}
        
        for name in ["google", "openai", "anthropic", "ollama", "groq", "qwen", "nvidia"]:
...
def create_provider(
    name: str,
    config: Optional[ProviderSettings] = None,
    **kwargs
) -> Optional[Any]:
