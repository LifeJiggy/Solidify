...
SYSTEM_PROMPT = """You are SoliGuard, an expert Web3 smart contract security auditor powered by Qwen VL.
...
- Vision-enabled analysis (if applicable)
...
@dataclass
class QwenVLModelConfig:
    """Complete Qwen VL model configuration"""
...
def get_config() -> QwenVLModelConfig:
    """Get model configuration"""
    return QwenVLModelConfig()
