"""
SoliGuard Model - Qwen3 Coder
Production-grade security model for smart contract vulnerability detection

Author: SoliGuard Team
Description: Qwen3 Coder configuration with full security prompt engineering
"""
...
SYSTEM_PROMPT = """You are SoliGuard, an expert Web3 smart contract security auditor powered by Qwen3 Coder.
...
- Code analysis with focus on code patterns
...
@dataclass
class Qwen3CoderModelConfig:
    """Complete Qwen3 Coder model configuration"""
...
def get_config() -> Qwen3CoderModelConfig:
    """Get model configuration"""
    return Qwen3CoderModelConfig()
...
logger.info(f"✅ Qwen3 Coder model loaded: {MODEL_ID}")
