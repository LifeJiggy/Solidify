...
MODEL_ID = "qwen3-security"
MODEL_NAME = "Qwen3 Security"
PROVIDER = "alibaba"
...
@dataclass
class Qwen3SecurityModelConfig:
    """Complete Qwen3 Security model configuration"""
...
def get_config() -> Qwen3SecurityModelConfig:
    """Get model configuration"""
    return Qwen3SecurityModelConfig()
...
logger.info(f"✅ Qwen3 Security model loaded: {MODEL_ID}")
