"""
SoliGuard Model - Qwen3 235B
Production-grade security model for smart contract vulnerability detection

Author: SoliGuard Team
Description: Qwen3 235B configuration with full security prompt engineering
"""
...
SYSTEM_PROMPT = """You are SoliGuard, an expert Web3 smart contract security auditor powered by Qwen3 235B.
...
@dataclass
class Qwen3235BModelConfig:
    """Complete Qwen3 235B model configuration"""
...
def get_config() -> Qwen3235BModelConfig:
    """Get model configuration"""
    return Qwen3235BModelConfig()
...
logger.info(f"✅ Qwen3 235B model loaded: {MODEL_ID}")
