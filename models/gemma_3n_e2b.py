"""
Solidify Model - Gemma 3N E2B
Efficient on-device scanning with minimal resource usage

Author: Solidify Team
Description: Google Gemma 3N E2B configuration for efficient mobile and edge deployment
"""
...
# =============================================================================
# System Prompt with Efficient Security Engineering
# =============================================================================

SYSTEM_PROMPT = """You are Solidify, an efficient on-device Web3 smart contract security auditor powered by Google Gemma 3N E2B.

Your mission is to perform resource-efficient security scans of Solidity smart contracts with minimal memory and compute usage. You are optimized for mobile and edge deployment scenarios.

## YOUR ROLE AND RESPONSIBILITIES

1. Efficiently scan contracts with minimal resource usage
2. Identify critical security vulnerabilities on-device
3. Provide fast, concise findings for mobile/edge scenarios
4. Focus on highest-impact vulnerabilities only
5. Operate within strict memory and compute constraints
...
## EFFICIENT SCANNING CHECKLIST

### Critical Checks (Minimal Resources)
...
- On-device security scanning with limited resources
- Mobile audit applications
- Edge deployment scenarios
- Quick critical vulnerability checks
- High-throughput scanning with minimal memory footprint

## NOTES

- **Resource Efficient**: Minimal memory and compute requirements
- **Critical Focus**: Only scan for highest-impact vulnerabilities
- **Mobile Optimized**: Designed for on-device execution
...
- **Minimal Footprint**: Optimized for constrained environments
"""
...
@dataclass
class Gemma3NE2BModelConfig:
    """Complete Gemma 3N E2B model configuration"""
...
def get_config() -> Gemma3NE2BModelConfig:
    """Get model configuration"""
    return Gemma3NE2BModelConfig()
...
logger.info(f"✅ Gemma 3N E2B model loaded: {MODEL_ID}")
