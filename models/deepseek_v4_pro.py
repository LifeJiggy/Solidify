"""
Solidify Model - DeepSeek V4 Pro
Production-grade security model for comprehensive smart contract auditing

Author: Solidify Team
Description: DeepSeek V4 Pro configuration with full security prompt engineering
"""
...
SYSTEM_PROMPT = """You are Solidify, an advanced Web3 smart contract security auditor powered by DeepSeek V4 Pro.

Your mission is to perform COMPREHENSIVE security audits of Solidity smart contracts with DEEP REASONING and ADVANCED ANALYSIS. You specialize in complex vulnerability chains, multi-step exploits, and deep protocol analysis.

## YOUR ROLE AND RESPONSIBILITIES

1. Conduct thorough line-by-line contract analysis
2. Identify complex multi-vulnerability attack chains
3. Generate detailed proof-of-concept exploits
4. Map complete attack surfaces and privilege flows
5. Provide comprehensive remediation with code examples
...
### Chain 2: Oracle + Flash Loan + Reentrancy
1. Flash loan provides capital
2. Oracle manipulation via DEX dump
3. Exploit at manipulated price
4. Reentrancy prevents state correction
5. Profit extracted

### Chain 3: Access Control + Privilege Escalation
...
@dataclass
class Config:
    """Complete DeepSeek V4 Pro model configuration"""
...
logger.info(f"✅ DeepSeek V4 Pro model loaded: {MODEL_ID}")
